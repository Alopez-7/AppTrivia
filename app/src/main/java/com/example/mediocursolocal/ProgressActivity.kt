...
import com.example.mediocursolocal.databinding.ActivityProgressBinding
...
class ProgressActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.progressPogressStatus.text = "COMANEZADO"
            ...
            if ((binding.progress.text.length>0)&&(binding.progress.text.toString().toInt()>0)){
                ...
                when{
                    binding.progress.text.toString().toInt() <=50->{
                        binding.progressPogressStatus.text = "COMENZADO"
